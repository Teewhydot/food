...
void main() {
  group('FileUploadRepositoryImpl', () {
    ...
    setUp(() {
      ...
      mockFile = MockFile();
      repository = FileUploadRepositoryImpl(
    ...
    group('uploadFile', () {
      ...
      test('should return UploadedFileEntity when upload succeeds', () async {
        ...
        when(
          () => mockRemoteDataSource.uploadFile(
            file: any(named: 'file'),
    ...
    group('deleteFile', () {
      test('should return success when deletion succeeds', () async {
        // Arrange
        when(
          () => mockRemoteDataSource.deleteFile(fileId: any(named: 'fileId')),
        ).thenAnswer((_) async {});
        ...
        verify(
          () => mockRemoteDataSource.deleteFile(fileId: 'test_file_id'),
        ).called(1);
      });
    ...
    group('generateFileUrl', () {
      test('should return URL from remote data source', () {
        ...
        const expectedUrl =
            'https://ik.imagekit.io/test/tr:w-300,h-200/food-app/test.jpg';

        when(
          () => mockRemoteDataSource.generateUrl(
            filePath: filePath,
